(() => {
  ...
  const ORDER_UI_VERSION='0.5.20.9';
  ...
  async function getOrderPushRegistration(){
    ...
    return navigator.serviceWorker.register('./sw.js?v=5.7.9.24',{scope:'./',updateViaCache:'none'});
  }
