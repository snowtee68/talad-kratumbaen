(() => {
  ...
  function injectUI(){
    if(!document.querySelector('link[href*="order.css"]')){const css=document.createElement('link');css.rel='stylesheet';css.href='order.css?v=0.3.1';document.head.appendChild(css);}
  ...
  function wire(){
    ...
    document.addEventListener('change',e=>{const el=e.target.closest('[data-draft-field]');if(el)draftFieldChanged(el);});
  }
