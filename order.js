(() => {
  ...
  const ORDER_UI_VERSION='0.5.20.12';
  ...
  function decorateShopCards(){
    ...
    document.querySelectorAll('.card[data-id]').forEach(card=>{
      ...
      const b=document.createElement('button');b.className='market-order-btn';b.dataset.marketOrderShop=id;b.textContent='🛒 สั่งซื้อผ่านตลาด';b.style.cssText='display:block;width:100%;max-width:none;margin:12px auto 4px;border:0;border-radius:12px;background:#8f0d12;color:#fff;padding:14px 12px;min-height:52px;text-align:center;white-space:nowrap;font:800 clamp(14px,3.8vw,17px) Prompt,sans-serif;box-shadow:0 5px 14px rgba(143,13,18,.28);cursor:pointer';actions.appendChild(b);
    });
  ...
  async function getOrderPushRegistration(){
    ...
    return navigator.serviceWorker.register('./sw.js?v=5.7.9.27',{scope:'./',updateViaCache:'none'});
  }
