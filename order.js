(() => {
  ...
  const ORDER_UI_VERSION='0.5.20.11';
  ...
  async function getOrderPushRegistration(){
    ...
    return navigator.serviceWorker.register('./sw.js?v=5.7.9.26',{scope:'./',updateViaCache:'none'});
  }
