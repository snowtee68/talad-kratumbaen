(() => {
  ...
  async function getOrderPushRegistration(){
    ...
    return navigator.serviceWorker.register('./sw.js?v=0.5.22.23',{scope:'./',updateViaCache:'none'});
  }
