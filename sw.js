const CACHE_NAME = 'talad-kratumbaen-v0.5.22.43';
const CORE = [
  './',
  './index.html',
  './styles.css',
  ...
  './icons/icon-192.png?v=0.5.22.43',
  './icons/icon-512.png?v=0.5.22.43',
  './icons/icon-maskable-512.png?v=0.5.22.43',
  './icons/apple-touch-icon.png?v=0.5.22.43'
];
