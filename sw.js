const CACHE_NAME = 'talad-kratumbaen-v0.5.22.106';
...
const CORE = [
  ...
  './icons/icon-192.png?v=0.5.22.106',
  './icons/icon-512.png?v=0.5.22.106',
  './icons/icon-maskable-512.png?v=0.5.22.106',
  './icons/apple-touch-icon.png?v=0.5.22.106'
];
