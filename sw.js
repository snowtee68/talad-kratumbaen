const CACHE_NAME = 'talad-kratumbaen-v0.5.22.89';
const CORE = [
  './',
  './index.html',
  './styles.css',
  ...
  './icons/icon-192.png?v=0.5.22.89',
  './icons/icon-512.png?v=0.5.22.89',
  './icons/icon-maskable-512.png?v=0.5.22.89',
  './icons/apple-touch-icon.png?v=0.5.22.89'
];
...
self.addEventListener('notificationclick', event => {
  ...
  event.waitUntil((async () => {
    ...
    // V0.5.22.89: iOS/PWA may focus an existing window while dropping/normalizing
