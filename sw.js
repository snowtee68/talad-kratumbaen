const CACHE_NAME = 'talad-kratumbaen-v0.5.22.95';
const CORE = [
  './',
  './index.html',
  './styles.css',
  ...
  './icons/icon-192.png?v=0.5.22.95',
  './icons/icon-512.png?v=0.5.22.95',
  './icons/icon-maskable-512.png?v=0.5.22.95',
  './icons/apple-touch-icon.png?v=0.5.22.95'
];
...
self.addEventListener('notificationclick', event => {
  ...
  event.waitUntil((async () => {
    ...
    // V0.5.22.95: iOS/PWA may focus an existing window while dropping/normalizing
