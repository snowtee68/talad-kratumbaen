const CACHE_NAME = 'talad-kratumbaen-v0.5.22.130-r1';
...
const CORE = [
  ...
  './icons/icon-192.png?v=0.5.22.130-r1',
  './icons/icon-512.png?v=0.5.22.130-r1',
  './icons/icon-maskable-512.png?v=0.5.22.130-r1',
  './icons/apple-touch-icon.png?v=0.5.22.130-r1'
];
