const CACHE_NAME = 'talad-kratumbaen-v0.5.22.42';
const CORE = [
  './',
  './index.html',
  './styles.css',
  ...
  './icons/icon-192.png?v=0.5.22.42',
  './icons/icon-512.png?v=0.5.22.42',
  './icons/icon-maskable-512.png?v=0.5.22.42',
  './icons/apple-touch-icon.png?v=0.5.22.42'
];
