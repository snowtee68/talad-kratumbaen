const CACHE_NAME = 'talad-kratumbaen-v0.5.22.117';
...
const CORE = [
  ...
  './icons/icon-192.png?v=0.5.22.117',
  './icons/icon-512.png?v=0.5.22.117',
  './icons/icon-maskable-512.png?v=0.5.22.117',
  './icons/apple-touch-icon.png?v=0.5.22.117'
];
