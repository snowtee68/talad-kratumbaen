const CACHE_NAME = 'talad-kratumbaen-v0.5.22.94';
const CORE = [
  './',
  './index.html',
  './styles.css',
  ...
  './icons/icon-192.png?v=0.5.22.94',
  './icons/icon-512.png?v=0.5.22.94',
  './icons/icon-maskable-512.png?v=0.5.22.94',
  './icons/apple-touch-icon.png?v=0.5.22.94'
];
...
self.addEventListener('notificationclick', event => {
  ...
  event.waitUntil((async () => {
    ...
    // V0.5.22.94: iOS/PWA may focus an existing window while dropping/normalizing
